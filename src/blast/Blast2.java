...
public class Blast2 extends ActionSupport{
	...
	public String execute(){
		...
		try {  
            ...
            Process pr1 = rt1.exec("cmd /c "+"perl E:\\Magic\\fasta_extract2.pl zea_mays_v3.25.fa"+chromosome+" "+sposition+" "+eposition+" "+filePath+"region.fasta "); // cmd /c calc  
            ...
            System.out.println("cmd /c "+"perl E:\\Magic\\fasta_extract2.pl zea_mays_v3.25.fa"+chromosome+" "+sposition+" "+eposition+" "+filePath+"region.fasta ");
		...
		try {  
            ...
            filePath = filePath.substring(1);
            filePath = filePath.replaceAll("\\/","\\\\");
            Process pr1 = rt1.exec("cmd /c "+"type "+filePath+"region.fasta "+filePath+"parameter.input > "+filePath+"p3.input"); // cmd /c calc  
            //type C:\Users\xinwang\Desktop\work\primer3\region.fasta C:\Users\xinwang\Desktop\work\primer3\parameter.input >C:\Users\xinwang\Desktop\work\primer3\p3.input
            System.out.println("cmd /c "+"type"+ filePath+"region.fasta"+filePath+"parameter.input >"+filePath+"p3.input");
            BufferedReader input1 = new BufferedReader(new InputStreamReader(pr1.getInputStream(), "GBK"));  
		...
		try {  
            ...
            Process pr3 = rt3.exec("cmd /c "+"E: & cd E:\\Magic\\primer3 & primer3_core.exe <"+filePath+"p3.input"); // cmd /c calc  
            //Process pr3 = rt3.exec("cmd /c "+"cd C:\\Users\\xinwang\\Desktop\\work\\primer & primer3_core.exe <"+filePath+"p3.input"); // cmd /c calc  
            
            System.out.println("cmd /c "+"cd C:\\Users\\xinwang\\Desktop\\work\\primer & primer3_core.exe <"+filePath+"p3.input");
		...
		try {  
            ...
            filePath = filePath.replaceAll("\\/","\\\\");
            Runtime rt1 = Runtime.getRuntime(); 
            Process pr1 = rt1.exec("cmd /c "+"copy E:\\Magic\\primer3\\primerexample.for "+filePath); // cmd /c calc  
		...
		try {  
            ...
            filePath = filePath.replaceAll("\\/","\\\\");
            Runtime rt1 = Runtime.getRuntime(); 
            //Process pr1 = rt1.exec("cmd /c "+"copy C:\\Users\\xinwang\\Desktop\\work\\primer\\primerexample.int "+filePath); // cmd /c calc  
            Process pr1 = rt1.exec("cmd /c "+"copy E:\\Magic\\primer3\\primerexample.int "+filePath); // cmd /c calc  
            System.out.println("copy C:\\Users\\xinwang\\Desktop\\work\\primer\\primerexample.int "+filePath);
		...
		try {  
            ...
            Process pr1 = rt1.exec("cmd /c "+"copy  E:\\Magic\\primer3\\primerexample.rev "+filePath); // cmd /c calc  
            
            System.out.println("cmd /c "+"copy C:\\Users\\xinwang\\Desktop\\work\\primer\\primerexample.rev "+filePath);
		...
		try {
            String encoding="GBK";
            String filePath=getWebRoot();
            filePath = filePath+"file/primerexample.for";//for件路径
		...
		try {
            ...
            String filePath=getWebRoot();
            filePath = filePath+"file/primerexample.int";//int文件路径
            File file=new File(filePath);
            	if(file.isFile() && file.exists()){ //判断文件是否存在
            		InputStreamReader read = new InputStreamReader(
            		new FileInputStream(file),encoding);//考虑到编码格式
		...
		try {
            ...
            String filePath=getWebRoot();
            filePath = filePath+"file/primerexample.rev";//rev文件路径
            File file=new File(filePath);
            	if(file.isFile() && file.exists()){ //判断文件是否存在
            		InputStreamReader read = new InputStreamReader(
            		new FileInputStream(file),encoding);//考虑到编码格式
