...
<body>
	...
	<%@ include file="../py_scripts/chrome.html" %>
		...
		<div class="describe">
			<h3>Bin Map</h3>
			<br />
			<p>The Visualisation of mosaic haplotypes for progenies in
				synthetic population, reflecting a high-resolution reshuffle across
				24 founders genomes.</p>
		</div>
		<div class="steps">
...
<!-- 	<script>
		...
		setTimeout("change()",10000);
			...
			function change() {
				document.getElementById("ifrID").src = "py_scripts/chrome.html";
				alert("As");
			}
	</script> -->
</body>
